...
{
    class FolderNamePicker : IGK.ICore.WinUI.Common.FolderNamePicker
    {
        FolderBrowser2 m_fbd;

        public FolderNamePicker()
        {
            this.m_fbd = new FolderBrowser2();
        }
        /// <summary>
        /// bolder browser dialog class method ok
        /// </summary>
        ...
        {
            var r= (enuDialogResult)this.m_fbd.ShowDialog(null);
            if (r == enuDialogResult.OK)
                this.SelectedFolder = this.m_fbd.DirectoryPath;
            return r;
        }
    }
}
