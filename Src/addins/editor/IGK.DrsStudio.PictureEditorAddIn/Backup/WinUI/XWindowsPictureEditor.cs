...
using IGK.ICore;using IGK.DrSStudio.Drawing2D;
        ...
        IGK.DrSStudio.WinUI.ICoreWorkingFilemanagerSurface 
    {
        ...
        public override ICoreWorkbench Workbench
        {
            get {
        ...
        {
            this.c_nextSurface.SaveAs(filename );
        }
        #endregion
        public string GetDefaultFilter()
        {
            return "Picture files |*.bmp; *.jpg;*.jpeg;*.png;*.gif";
        }
        public ICoreSaveAsInfo GetSaveAsInfo()
        {
            return new CoreSaveAsInfo("Save XML File",
                GetDefaultFilter(),
                this.FileName);
        }
    }
