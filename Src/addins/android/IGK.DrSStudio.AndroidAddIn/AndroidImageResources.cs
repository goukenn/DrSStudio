...
namespace IGK.DrSStudio.Android
{
    ...
    class AndroidImageResources
    {
        ...
        internal static System.Windows.Media.ImageSource GetImage(string p)
        {
            if (sm_res == null)
