...
using IGK.ICore;using IGK.DrSStudio.WinUI;
    ...
    [CoreCodec ("XIconEncoder","drs/x-icon", "ico",Category=CoreConstant.CAT_PICTURE)]
    class CoreIconEncoder : CoreEncoderBase 
    {
        ...
        protected XIcon GetXIcon(ICoreWorkingDocument[] documents)
        {
            ...
            int i = 0;
            Bitmap obmp = null;
            foreach (Core2DDrawingDocumentBase doc in documents)
            {
                if (v_ico == null)
                {
                    ...
                    //g.Clear(Color.Red);
                    obmp = WinCoreBitmapOperation.GetGdiBitmap(doc, CoreScreen.DpiX , CoreScreen.DpiY );
