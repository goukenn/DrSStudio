...
namespace IGK.DrSStudio.WebAddIn.HtmlCanva.Codec
{
    ...
    /// <summary>
    /// converter compatible with balafonjs specification
    /// </summary>
    [CoreCodec("BALAFON.Drawing2DConvertToCanvaEncoder", 
        "text/balafon-canvas-script", 
        "bcjs",
        Category=CoreConstant.CAT_PICTURE+";"+CoreConstant.CAT_FILE)]//igkweb canva js
    class BalafonHtmlCanvaEncoder :  CoreEncoderBase
    {
