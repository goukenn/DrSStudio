...
namespace IGK.DrSStudio.WiXAddIn.Menu.WiX
{
    ...
    //[DrSStudioMenu("Wix.AddVariable", 20, SeparatorBefore = true)]
    //class _WiXAddVariable: WiXMenuBase
    //{
    //    protected override bool PerformAction()
    //    {
    //        using (ICoreDialogForm d = Workbench.CreateNewDialog())
    //        {
    //            //WiXVariableControl c = new WiXVariableControl();
    ...
    //            //{
    //            //    this.CurrentSurface.Project.Variables.Add(c.Variable, c.FileName);
    //            //}
    //        }
