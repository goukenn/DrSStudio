...
namespace IGK.DrSStudio.Drawing2D
{
    ...
    [Core2DDrawingStandardElement("TextRichZone", typeof(Mecanism))]
    class RichTextZoneElement : RectangleElement, ICoreTextValueElement, ICore2DDrawingVisitable
    {
        ...
        public RichTextZoneElement()
        {
            this.m_FontBrush = new CoreBrush(this);
            this.m_Font = new CoreFont (this, CoreConstant.DEFAULT_FONT_NAME);
            this.m_Font.FontSize = 12; this.Text = "Sample text zone";
        ...
        {
            IXRichtTextControl c_textControl;
            ...
            public override bool Register(WinUI.ICore2DDrawingSurface t)
            {
                if (base.Register(t))
                {
                    this.c_textControl = CoreControlFactory.CreateControl("IGKXRichTextControl")
                        as IXRichtTextControl;
