...
{
    class UIPreviewDocument : IGKXUserControl
    {
        private IGKXPanel xPanel2;
        private IGKXLabel xLabel2;
        private IGKXTextBox c_height;
        private IGKXTextBox c_width;
        ...
        private void InitializeComponent()
        {
            ...
            this.c_btn_preview = new IGKXButton();
            this.xLabel2 = new IGKXLabel();
            this.c_height = new IGKXTextBox();
            this.c_width = new IGKXTextBox();
            ...
            this.c_btn_preview.DialogResult = enuDialogResult.None;
            ...
            this.c_btn_preview.State = enuButtonState.Normal;
        ...
        private void PreviewDocument()
        {
            ...
            d.ClipView = true ;
            d.Draw(g, new Rectanglei(0, 0, bmp.Width, bmp.Height));
            d.Dispose();
            g.Flush();
            g.Dispose();
        ...
        private void xButton1_Click(object sender, EventArgs e)
        {
            ...
            {
                Workbench.ConfigureWorkingObject(this.CurrentDocument, "title.previewdocument".R(), false, new Size2i(420,510)  );
                this.PreviewDocument();
            }
        }
    }
