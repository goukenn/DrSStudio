...
file: _ClearTransformContextMenu.cs
...
{
    [DrSStudioContextMenu("Drawing2DEdit.Transform.ClearTransform", 0)]
    sealed class _ClearTransformContextMenu : TransformChilds
    {
