...
namespace IGK.DrSStudio.Imaging.Effects
{
    ...
    public abstract class Effect : IDisposable
    {
        ...
        {
            if(this is ILegacyEffect) GdiNativeFunction.CheckAvailable();
            mbInvalid = true;
            mgGuid = guid;
        }
        ...
        internal Bitmap CloneApply(Bitmap bitmap, ref Rectangle rect)
        {
            ...
            GdiNativeFunction.CheckAvailable();

            // Initialise values
            GdiNativeFunction.GdiRECT lrRect = GdiNativeFunction.GdiRECT.FromRectangle(rect);
            GdiNativeFunction.GdiRECT lrOutRect = new GdiNativeFunction.GdiRECT();
            ...
            // Call function
            if (rect.IsEmpty)
                liStatus = GdiNativeFunction.GdipBitmapCreateApplyEffect(
                    ref lipAddr, 1,
            ...
            if (lipAuxData != IntPtr.Zero)
                GdiNativeFunction.GdipFree(lipAuxData);
        ...
        internal void ApplyToBitmap(Bitmap bitmap, Rectangle rectOfInterest)
        {
            ...
            // Initialise values
            GdiNativeFunction.GdiRECT lrRect = GdiNativeFunction.GdiRECT.FromRectangle(rectOfInterest);
            bool lbUseAuxData = (this is IAuxDataEffect) && ((IAuxDataEffect)this).UseAuxData;
            ...
            if (rectOfInterest.IsEmpty)
                liStatus = GdiNativeFunction.GdipBitmapApplyEffect(
        ...
        protected void ValidateParameters()
        {
            ...
            {
                liStatus = GdiNativeFunction.GdipCreateEffect(mgGuid, out mipNativeHandle);
                GdiNativeFunction.CheckErrorStatus(liStatus);
            }
        ...
        protected void SetParameters(object structure)
        {
            ...
            if (ParametersPinnable())
            {
                ...
                try
                {
                    ...
                    // Set the parameters
                    liStatus = GdiNativeFunction.GdipSetEffectParameters(mipNativeHandle, lhHandle.AddrOfPinnedObject(), luiSize);
            ...
            else
            {
                ...
                try
                {
                    ...
                    uint luiSize = GetParameterDataSize(liSize, structure);
                    liStatus = GdiNativeFunction.GdipSetEffectParameters(mipNativeHandle, lipParams, luiSize);
                    GdiNativeFunction.CheckErrorStatus(liStatus);
                }
                finally
                {
        ...
        protected uint GetParametersSize()
        {
            ...
            uint luiSize;
            int liStatus = GdiNativeFunction.GdipGetEffectParameterSize(mipNativeHandle, out luiSize);
            GdiNativeFunction.CheckErrorStatus(liStatus);
        ...
        protected void DisposeEffect()
        {
            if (mipNativeHandle != IntPtr.Zero)
            {
                int liStatus = GdiNativeFunction.GdipDeleteEffect(mipNativeHandle);
                GdiNativeFunction.CheckErrorStatus(liStatus);
