...
file: LegacyBitmapPerPixelEffect.cs
...
namespace IGK.DrSStudio.Imaging.EffectsInternal
{
    ...
    internal static class LegacyBitmapPerPixelEffect
    {
        ...
        public static void GetColorCurveLUT(
            GdiNativeFunction.GpCurveAdjustments adjustment, int adjustValue, ref byte[] lut)
        {
            ...
            switch (adjustment)
            {
                case GdiNativeFunction.GpCurveAdjustments.AdjustContrast:
                ...
                case GdiNativeFunction.GpCurveAdjustments.AdjustShadow:
                ...
                case GdiNativeFunction.GpCurveAdjustments.AdjustHighlight:
                    lfLen = (float)(adjustValue / 100f) * 0.25f;
                ...
                case GdiNativeFunction.GpCurveAdjustments.AdjustMidtone:
                ...
                case GdiNativeFunction.GpCurveAdjustments.AdjustBlackSaturation:
                ...
                case GdiNativeFunction.GpCurveAdjustments.AdjustWhiteSaturation:
                    lfLen = (float)(adjustValue / 100f) * 0.39f;
                    ldInValues = new QuadraticBezierCurve.Point[] {
            ...
            for (int liCounter = 0; liCounter < 256; liCounter++)
            {
                ...
                switch (adjustment)
                {
                    case GdiNativeFunction.GpCurveAdjustments.AdjustExposure:
                    case GdiNativeFunction.GpCurveAdjustments.AdjustDensity:
            ...
            Rectangle rect, int threads, PixelFormat pixelFormat)
        {
            ...
            unsafe
            {
                Proc.ApplyPerPixel(
                    ...
                    (d, t) =>
                    {
                        ...
                        int liLum = GdiNativeFunction.Luminosity((*(C32*)d).R, (*(C32*)d).G, (*(C32*)d).B);
                        ...
                        liLum -= GdiNativeFunction.Luminosity(liR, liG, liB);
            ...
            Proc.ApplyPerPixel(
                ...
                (d, t) =>
                {
                    ...
                    // Calculate original luminosity
                    int liLum = GdiNativeFunction.Luminosity(liR, liG, liB);
