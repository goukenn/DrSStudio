...
{
    struct CoreRGBAColor
    {
        internal byte r;
        internal byte g;
        internal byte b;
        internal byte a;
        public CoreRGBAColor(byte r, byte g, byte b, byte a)
        {
            this.r = r;
            this.b = b;
            this.g = g;
        ...
        public static CoreRGBAColor FromColor(Color cl)
        {
            return new CoreRGBAColor((byte)cl.R,
                (byte)cl.G,
                (byte)cl.B,
                (byte)cl.A);
        }
