...
{
    using IGK.DrSStudio.Drawing2D.Effects.NoiseEffect;
    ...
    public class NoiseEffect : ImageEffectBase, IDisposable 
    {
        ...
        public override ICoreParameterConfigCollections GetParameters(ICoreParameterConfigCollections parameters)
        {
            ...
            g.AddTrackbar(t.GetProperty("RandomMax"), 0, 255, this.m_RandomMax, (object o, CoreParameterChangedEventArgs e ) => { 
                int i =Convert.ToInt32 ( e.Value);
                if ((i >= 0) && (i <= 255)) {
                    this.RandomMax =(byte) i;
                }
            });
            g.AddTrackbar(t.GetProperty("Offset"), 0, 255, this.m_RandomMax, (object o, CoreParameterChangedEventArgs e) =>
            {
                int i = Convert.ToInt32(e.Value);
                if ((i >= 0) && (i <= 255))
                {
