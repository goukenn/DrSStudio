...
{
    [DrSStudioMenu("Image.Convolutions.Custom", 
        Int32.MaxValue, 
        SeparatorBefore=true )]
    public sealed class CustomConvolutionMenu : ImageMenuBase 
    {
        protected override bool PerformAction()
        {
            XCustomConvolutionControl ctr = new XCustomConvolutionControl();
            using (ICoreDialogForm frm = Workbench.CreateNewDialog(ctr))
            {
                ...
                frm.Title = CoreSystem.GetString("DLG.CustomConvolution.Caption");
