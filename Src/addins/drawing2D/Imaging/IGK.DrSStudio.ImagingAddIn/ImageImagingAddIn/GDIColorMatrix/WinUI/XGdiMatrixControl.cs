...
namespace IGK.DrSStudio.Drawing2D.WinUI
{
    ...
    /// <summary>
    /// represent a color matrix setter control
    /// </summary>
...
: UIXConfigControlBase
    {
        ...
        public ImageElement ImageElement
        {
            ...
            set
            {
                if (m_ImageElement != value)
                {
                    ...
                    if (value != null)
                    {
                        this.m_oldBitmap = value.Bitmap.ToGdiBitmap().Clone() as Bitmap;// ;//.Clone() as Bitmap;
                    }
                }
            }
        }
        ...
        private void InitializeComponent()
        {
            ...
            this.Size = new System.Drawing.Size(318, 271);
            ...
            try
            {
             ...
             this.ImageElement.SetBitmap(
                    ...
                    this.ColorMatrixFlag ,
                     ColorAdjustType.Bitmap ).ToCoreBitmap(), temp
                    );
        ...
        {
            this.ImageElement.SetBitmap(this.m_oldBitmap.ToCoreBitmap (), true);
        }
