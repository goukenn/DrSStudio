...
namespace IGK.DrSStudio.Drawing2D.WinUI
{
    ...
    /// </summary>
    public class UIXRemapColor : UIXConfigControlBase
    {
        ...
        {
            this.factor = 1;
            this.m_oldlimage = ImagingUtils.GetClonedBitmap(this.ImageElement.Bitmap);
            BuildBeforePicture();
        ...
        static ICoreBitmap ApplyProperty(Bitmap picbmp, Colorf oldColor, Colorf newColor, float factor)
        {
            if (picbmp == null)
            ...
            if (factor == 1)
            {
                ...
                cl.OldColor = oldColor.ToGdiColor();
                cl.NewColor = newColor.ToGdiColor();
                int w = picbmp.Width;
                int h = picbmp.Height;
                ...
                g.Flush();
                g.Dispose();
                return WinCoreBitmap.Create (bmp);
            }
            else
            {
        ...
        static ICoreBitmap BuilImageMultiple(Bitmap picbmp, 
            Colorf oldColor, 
            Colorf nColor, 
            float factor)
        {
            ...
            for (int j = 0; j < h; ++j)
            {
                for (int i = 0; i < w; ++i)
                {
                    ...
                    g = data[offset + 1];
                    b = data[offset + 2];
                    cl_hsv2 = CoreColorHandle.RGBtoHSV(Colorf.FromIntArgb(255, r, g, b));
                    angle2 = (cl_hsv2.Hue * 360 / 255.0f);
                    if (Math.Abs(angle2 - angle) <= step)
                    {
                        data[offset] = (nColor.R * 255).TrimByte();
                        data[offset + 1] =( nColor.G * 255).TrimByte();
                        data[offset + 2] = (nColor.B * 255).TrimByte();
                    }
                }
            }
        ...
        {
            this.xRuleLabel1 = new IGK.ICore.WinUI.IGKXRuleLabel();
            ...
            this.uixColorPicker1 = new IGK.ICore.WinUI.UIXCoreColorPicker();
            this.picB_before = new System.Windows.Forms.PictureBox();
            this.xGroupBox1 = new IGK.DrSStudio.WinUI.IGKXGroupBox();
            this.uixColorPicker2 = new IGK.ICore.WinUI.UIXCoreColorPicker();
            this.picB_After = new System.Windows.Forms.PictureBox();
            this.xLabel5 = new IGK.ICore.WinCore.WinUI.Controls.IGKXLabel();
            this.xDualColorTrackBar1 = new IGK.ICore.WinUI.IGKXDualColorTrackBar();
            this.label1 = new System.Windows.Forms.Label();
            this.btn_apply = new IGK.ICore.WinCore.WinUI.Controls.IGKXButton();
            ...
            this.xRuleLabel1.HorizontalAlignment = IGK.ICore.Drawing2D.enuStringAlignment.Near;
            ...
            this.xRuleLabel1.VerticalAlignment = IGK.ICore.Drawing2D.enuStringAlignment.Near;
            ...
            // grb_before
            // 
            this.grb_before.CaptionKey = null;
            ...
            // uixColorPicker1
            // 
            this.uixColorPicker1.AcceptButton = null;
            this.uixColorPicker1.CancelButton = null;
            ...
            // xGroupBox1
            // 
            this.xGroupBox1.CaptionKey = null;
            ...
            // uixColorPicker2
            // 
            this.uixColorPicker2.AcceptButton = null;
            this.uixColorPicker2.CancelButton = null;
            this.uixColorPicker2.CaptionKey = null;
            ...
            this.xLabel5.HorizontalAlignment = IGK.ICore.Drawing2D.enuStringAlignment.Near;
            ...
            this.xLabel5.VerticalAlignment = IGK.ICore.Drawing2D.enuStringAlignment.Near;
            // 
            // xDualColorTrackBar1
            // 
            this.xDualColorTrackBar1.CaptionKey = null;
            this.xDualColorTrackBar1.Cursor = System.Windows.Forms.Cursors.Hand;
            this.xDualColorTrackBar1.DrawDash = false;
            ...
            this.btn_apply.Checked = false;
            this.btn_apply.DialogResult = IGK.ICore.WinUI.enuDialogResult.OK;
            this.btn_apply.Location = new System.Drawing.Point(413, 462);
            this.btn_apply.Name = "btn_apply";
            this.btn_apply.ShowButtonImage = false;
            this.btn_apply.Size = new System.Drawing.Size(75, 23);
            this.btn_apply.State = IGK.ICore.WinUI.enuButtonState.Normal;
        ...
        void PreviewBuildImage()
        {
            ...
            {
                Bitmap bmp = picB_before.Image as Bitmap;

                ICoreBitmap vbmp = ApplyProperty(bmp, this.StartColor, this.EndColor, this.factor);
                this.picB_After.Image = vbmp.ToGdiBitmap();
                vbmp.Dispose();
            }
        }
        ...
        private Colorf GetColor(Point point)
        {
            ...
            zoomy = zoomx;
            //get image location
            PointF v_imgstartlocation = new PointF((this.picB_before.Width - w * zoomx) / 2,
                (this.picB_before.Height - h * zoomy) / 2);
            PointF v_loc = new PointF(
              (point.X - v_imgstartlocation.X) / zoomx,
              (point.Y - v_imgstartlocation.Y) / zoomy);
            int v_w = (int)v_loc.X;
            int v_h = (int)v_loc.Y;
            if ((v_w >= 0) && (v_w < w) && (v_h >= 0) && (v_h < h))
                cl = (this.picB_before.Image as Bitmap).GetPixel((int)v_w, (int)v_h).CoreConvertFrom<Colorf>();
            return cl;
        }
