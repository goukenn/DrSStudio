...
namespace IGK.DrSStudio.Imaging.WinUI
{
        ...
        UIXImageSurfaceConfigBase      
    {
        ...
        public UIXAdjustImageCurveLevel(
            ImageElement image, ICoreWorkingRenderingSurface surface, CoreJobProgressEventHandler progress)
            : base()
        {
            if (image == null)
                throw new CoreException(enuExceptionType.ArgumentIsNull, "image");
            if(image.Bitmap.PixelFormat == 
            
                enuPixelFormat.Undefined )
            {
            ...
            m_splinepoint = new List<PointF>();
            m_splinepoint.Add(new PointF(0, 255));
            m_splinepoint.Add(new PointF(255, 0));
            m_index = -1;
        ...
        protected void Apply(bool temp)
        {
            ...
            v_path.AddCurve(this.m_splinepoint.ToArray());
        ...
        void OnJobProgress(float percent)
        {
            ...
            {
                this.m_jobProgess.BeginInvoke(this, (int)percent, null, null);
            }
        }
        private void InitializeComponent()
        {
            ...
            this.chb_red = new IGKXCheckBox();
            this.chb_g = new IGKXCheckBox();
            this.chb_b = new IGKXCheckBox();
            this.cmb_ColorMode = new IGKXComboBox();
            this.btn_red = new IGKXButton();
            this.btn_green = new IGKXButton();
            this.btn_blue = new IGKXButton();
            ...
            // chb_red
            // 
            this.chb_red.CaptionKey = "chb.red.Caption";
            ...
            // chb_g
            // 
            this.chb_g.CaptionKey = "chb.green.Caption";
            ...
            // chb_b
            // 
            this.chb_b.CaptionKey = "chb.blue.Caption";
        ...
        {
            int index = -1;
            PointF[] v_pt = m_splinepoint.ToArray();
        ...
        void Reset()
        {
            ...
            this.m_index = -1;
            this.m_demand = 0;
            this.m_splinepoint.Add(new PointF(0, 255));
            this.m_splinepoint.Add(new PointF(255, 0));
            this.pcb_histogram.Invalidate();
        }
        private void pcb_histogram_Paint(object sender, PaintEventArgs e)
        {
            ...
            {
                Pen v_pen = CoreBrushRegisterManager.GetPen<Pen>(Colorf.Black);
        ...
        class Snippet : IDisposable
        {
            ...
            void Invalidate(bool visible)
            {
                ...
                RectangleF rc = new RectangleF(this.m_histo.m_splinepoint[m_index], SizeF.Empty);
            ...
            void pcb_histogram_Paint(object sender, PaintEventArgs e)
            {
                if (this.m_visible == false)
                    return;
                // this.Dispose();
                RectangleF rc = new RectangleF(m_histo.m_splinepoint[m_index], Size.Empty);
