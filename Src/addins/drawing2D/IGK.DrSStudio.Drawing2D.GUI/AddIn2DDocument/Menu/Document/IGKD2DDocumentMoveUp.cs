...
namespace IGK.DrSStudio.Drawing2D.Menu.Document
{
    ...
    class IGKD2DDocumentMoveUp : IGKD2DDrawingDocumentMenuBase
    {
        protected override bool PerformAction()
        {
            ...
            if (i >= 0)
            {
                this.CurrentSurface.Documents.MoveToFront(this.CurrentDocument);
                return true;
            }
            return false;
        }
