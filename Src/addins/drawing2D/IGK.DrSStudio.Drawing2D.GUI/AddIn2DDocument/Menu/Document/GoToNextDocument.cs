...
{
    [IGKD2DDocumentMenuAttribute("GoToNextDocument", 0X21, IsShortcutMenuChild = true, Shortcut = enuKeys.Shift | enuKeys.Next)]
    class GoToNextDocument : IGKD2DDrawingDocumentMenuBase
    {
