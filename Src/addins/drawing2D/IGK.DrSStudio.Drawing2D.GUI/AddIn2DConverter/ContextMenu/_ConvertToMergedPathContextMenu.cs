...
{
    [IGKD2DConvertToContextMenuAttribute("MergedPath", 0)]
    class ConvertToMergedPathContextMenu : IGKD2DDrawingContextMenuBase
    {
        ...
        public ConvertToMergedPathContextMenu()
        {
