...
namespace IGK.DrSStudio.Drawing3D.OpenGL.Menu.Help
{
    [DrSStudioMenu("Help.GLInfo", 0x05)]
    public class OGLInfoMenu : CoreApplicationMenu, ICoreWorkingConfigurableObject 
    {
        protected override bool PerformAction()
        {
            this.Workbench.ConfigureWorkingObject(this, "title.openglinfo".R(), false, new Size2i(420, 510));
             return false;
        }
