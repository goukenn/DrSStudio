...
{
    public class IGKOGLGraphicSetting : IIGKOGL2DGraphicsSetting
    {

        private IIGKOGL2DWorkingObject m_Owner;

        public IIGKOGL2DWorkingObject Owner
        {
            get { return m_Owner; }
        }
        public IGKOGLGraphicSetting(IIGKOGL2DWorkingObject owner)
        {
            if (owner == null)
