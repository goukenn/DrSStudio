...
namespace IGK.GLLib
{
    public class GLException : ApplicationException
    {
        ...
        public enuGLError Code {get{return this.m_code;}}
        public GLException(enuGLError code)
        {
            this.m_code = code ;
            this.m_message = code.ToString();
        }
        public GLException(enuGLError code, string message)
        {
            this.m_code = code ;
