...
using System.Linq;
using System.Text;
namespace IGK.DrSStudio.WebProjectAddIn.XmlTextEditor.Settings
{
    [CoreEditorSetting(Name = "Editor.XmlEditorSetting")]
    sealed class XmlEditorSetting : CoreSettingBase 
    {
