...
file: WebBrowserDesignCategory.cs
...
{
    class WebBrowserDesignCategory : WebSolutionCategoryItem
    {
        ...
        public WebBrowserDesignCategory():base()
        {

        }
        public override ICoreControl GetConfigControl()
        {
            return new WebSolutionBrowserDesignSurface(this.WebSolution);
        }
