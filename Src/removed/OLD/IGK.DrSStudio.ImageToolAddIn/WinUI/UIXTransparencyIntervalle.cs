...
namespace IGK.DrSStudio.Drawing2D.WinUI
{
    ...
    /// </summary>
    public class UIXSetTransparencyColorKeyInterval : UIXConfigControlBase        
    {
        class ColorView : Control
        {
            ...
            void ColorView_Paint(object sender, PaintEventArgs e)
            {
                e.Graphics.FillRectangle(
                    CoreBrushRegister.GetBrush<Brush>(this.Color),
                    this.ClientRectangle);
                WinCoreControlPaint .DrawBorder (                
                    e.Graphics, 
                    this.ClientRectangle,
                    global::System.Drawing.Color.Black, 
        ...
        private IGKXBulletIntervalTrackBar c_r;
        ...
        {
            this.c_stColorView = new UIXSetTransparencyColorKeyInterval.ColorView();
            this.c_entColorView = new UIXSetTransparencyColorKeyInterval.ColorView();
            this.c_r = new IGKXBulletIntervalTrackBar();
            ...
            // xLabel1
            // 
            this.xLabel1.CaptionKey = "lb.R.Title";
            ...
            // xLabel2
            // 
            this.xLabel2.CaptionKey = "lb.G.Title";
            ...
            // xLabel3
            // 
            this.xLabel3.CaptionKey = "lb.B.Title";
        ...
        private void xBulletIntervalTrackBar2_IntervalChanged(object sender, EventArgs e)
        {
            ...
            this.c_stColorView.Color = Colorf.FromIntArgb(
                255,
                this.c_r.Interval.Min,
                this.c_g.Interval.Min,
                this.c_b.Interval.Min
                );
            this.c_entColorView.Color = Colorf.FromIntArgb(
                255,
                this.c_r.Interval.Max,
                this.c_g.Interval.Max,
                this.c_b.Interval.Max
