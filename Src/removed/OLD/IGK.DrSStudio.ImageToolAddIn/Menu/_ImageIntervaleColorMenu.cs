...
namespace IGK.DrSStudio.Drawing2D.Menu
{
    ...
    /// </summary>
    [IGK.DrSStudio.Menu.CoreMenu("Image.Tools.IntervaleColorMenu", 2, ImageKey="Menu_IntervalColorMenu")]
    sealed class _IntervaleColorMenu : ImageMenuBase
    {
        ...
        {
            internal _IntervaleColorMenu owner;
            internal Thread m_thread;
            public ThreadOperator(_IntervaleColorMenu owner)
            {
                this.owner = owner;
            }
        ...
        private void Apply(bool temp)
        {
            ...
            lock (this)
            {
                ...
                v_lTransk.Color1 = new LayerTransparencyKey.LTColor(
                    (byte)m_control.IntervalRed.Min,
                    (byte)m_control.IntervalGreen.Min,
                    (byte)m_control.IntervalBlue.Min
                    );
                v_lTransk.Color2 = new LayerTransparencyKey.LTColor(
