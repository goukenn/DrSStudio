...
namespace IGK.DrSStudio.Drawing2D.ContextMenu
{
    ...
    abstract class _RegionConverterContextMenuBase : Core2DContextMenuBase 
    {
        ...
        protected override void OnOpening(EventArgs e)
        {
            ...
            ICore2DDrawingSurface v_s =
                this.CurrentSurface;
            v = (v_s != null) && v_s.Mecanism.AllowContextMenu && (v_s .CurrentLayer .SelectedElements .Count > 0);
            this.Visible = v;
            this.Enabled = v;
        }
    }
