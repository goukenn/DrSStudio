...
namespace IGK.DrSStudio.AudioVideo.Menu
{
    ...
    public class VideoMenuBase : CoreApplicationMenu 
    {
        public new XVideoSurfaceBase CurrentSurface {
            get { return base.CurrentSurface as XVideoSurfaceBase; }
        }
        ...
        {
            this.Visible = (this.CurrentSurface != null);
