...
namespace IGK.DrSStudio.Drawing2D
{
    ...
    /// Pen Anchor element
    /// </summary>
    public struct CorePenLineCap : ICoreLineCap,
        IGK.DrSStudio.Codec.ICoreSerializerService,
        IGK.DrSStudio.ICoreWorkingDefinitionObject,
        ICoreWorkingConfigurableObject
    {
        ...
        private CorePenLineCap(string DisplayName, PathElement pathElement)
        {
            if (pathElement == null)
        ...
        public static CorePenLineCap[] LoadAnchor()
        {
            ...
            string dir = IGK.DrSStudio.IO.PathUtils.GetStartupFullPath("PenCap");
        ...
        public Core2DCustomLineCap GetCustomCap()
        {
            if (this.m_pathElement == null)
                return null;
            throw new NotImplementedException();
            //GraphicsPath v_path = this.m_pathElement.GetPath().Clone() as GraphicsPath;
            ...
            //v_path.Transform(m);
            //m.Dispose();
            //CustomLineCap v_lcap = null;
            //v_lcap = new CustomLineCap(null, v_path.Clone() as GraphicsPath, this.CustomCap, this.BaseInset);
        ...
        public static bool Save(PathElement path, string p, enuLineCap lineCap, float baseInset)
        {
            ...
            path.Serialize(deseri);
            deseri.Close();
            CorePenLineCap cap = new CorePenLineCap(p, path.Clone() as PathElement);
            ...
            switch (v_tstr.Length)
            {
                ...
                case 4:
                    ...
                    if (sm_PensLineCap.ContainsKey(this.m_displayName))
                    {
                        ...
                        {
                            this.m_pathElement = sm_PensLineCap[this.m_displayName].PathElement.Clone() as PathElement;
                            this.m_lineCap = enuLineCap.Custom;
                        }
                    }
                    break;
        ...
        {
            IGK.DrSStudio.WinUI.ICoreParameterConfigCollections param = parameters;
