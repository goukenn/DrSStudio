...
using System.Linq;
using System.Text;
namespace IGK.DrSStudio.Drawing2D.DocumentView.ContextMenu
{
    [IGK.DrSStudio.ContextMenu.CoreContextMenu ("Document.ExtractDocumentBlock", 130, SeparatorBefore=true)]
    sealed class _ExtractDocument : IGK.DrSStudio.Drawing2D.ContextMenu.Core2DContextMenuBase 
    {
        protected override bool PerformAction()
        {
            if (this.CurrentSurface.AllowMultipleLayer )
            {
