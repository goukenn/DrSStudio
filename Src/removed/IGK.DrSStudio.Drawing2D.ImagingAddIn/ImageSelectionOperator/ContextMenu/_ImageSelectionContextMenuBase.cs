...
namespace IGK.DrSStudio.Drawing2D.ImageSelection.ContextMenu
{
    ...
    public abstract class _ImageSelectionContextMenuBase : Core2DContextMenuBase 
    {
        private _ImageSelection.Mecanism m_mecanism;
        public _ImageSelection.Mecanism Mecanism
        {
        ...
        {
            if (CurrentSurface.CurrentTool  == typeof(_ImageSelection))
            {
                this.Visible = true;
            }
            else
        ...
        {
            if ((this.Mecanism !=null) && this.CurrentSurface .CurrentTool == (typeof(_ImageSelection)))
            {
