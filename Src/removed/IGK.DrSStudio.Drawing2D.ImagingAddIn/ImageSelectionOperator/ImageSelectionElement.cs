...
namespace IGK.DrSStudio.Drawing2D.ImageSelection
{
    ...
    [Core2DDrawingImageItemAttribute("ImageSelection",
        typeof(_ImageSelection.Mecanism),
        ImageKey ="DE_OPE")]
    public sealed class _ImageSelection : Core2DDrawingDualBrushBoundElement 
    {
        ...
        internal _ImageSelection(Mecanism mecanism)
        {
            ...
            //,ICoreDrawingImageOperation
        {
            ...
            private Timer m_tim;
            private _ImageSelection m_imgSelection;
            ...
            protected override void RegisterSurface(IGK.DrSStudio.Drawing2D.WinUI.ICore2DDrawingSurface surface)
            {
                ...
                m_menuCopySelection = CoreSystem.Instance.Actions[CONTEXTMENU_COPYSELECTION]
                    as _ImageSelectionContextMenuBase;
                m_menuCopySelection.Mecanism = this;
                m_menuSetSelection = CoreSystem.Instance.ContextMenus[CONTEXTMENU_SETSELECTIONMODE] as _ImageSelectionContextMenuBase;
                m_menuSetSelection.Mecanism = this;
                m_menuRegionSelection = CoreSystem.Instance.ContextMenus[CONTEXTMENU_SELECTREGION] as _ImageSelectionContextMenuBase;
            ...
            protected override void UnRegisterSurface(IGK.DrSStudio.Drawing2D.WinUI.ICore2DDrawingSurface surface)
            {
                Tools.SelectionRegionOperationTools.Instance.RegionOperationChanged -= new EventHandler(Instance_RegionOperationChanged);
                Tools.SelectionRegionOperationTools.Instance.RegionSelectionOperationTypeChanged -= new EventHandler(Instance_RegionSelectionOperationTypeChanged);
            ...
            public void SetElementToConfigure(ICoreWorkingObject  element)
            {
                if (element is ImageElement)
                {
                    ...
                    m_imgSelection = new _ImageSelection(this);
            ...
            protected override void OnMouseUp(IGK.DrSStudio.Drawing2D.WinUI.CoreMouseEventArgs e)
            {
                switch (e.Button)
                {
                    ...
                    case MouseButtons.Left:
                        ...
                        Vector2f screenEnd = this.EndPoint;// Surface.GetScreenLocation(vtb[1]);
                        Vector2f screenStart = this.StartPoint;// Surface.GetScreenLocation(vtb[0]);
            ...
            protected override void OnPaint(PaintEventArgs e)
            {
                ...
                s = e.Graphics.Save();
                Vector2f screenStart = CurrentSurface.GetScreenLocation(this.StartPoint);
                Vector2f screenEnd = CurrentSurface.GetScreenLocation(this.EndPoint);
            ...
            sealed class EditMecanismProperties :
                IGK.DrSStudio.Drawing2D.Actions.Core2DDrawingMecanismAction
            {
