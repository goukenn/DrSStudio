...
namespace IGK.ICore.Settings
{
    ...
    /// </summary>
    public abstract class CoreSettingAttributeBase : CoreAttribute
    {
        ...
        public CoreSettingAttributeBase()//(string Name)
        {
            this.m_Index = 0;
        }
        public CoreSettingAttributeBase(string name)
        ...
        internal static CoreSettingAttributeBase GetAttribute(Type type)
        {
            try
            {
                object[] obj = type.GetCustomAttributes(typeof(CoreSettingAttributeBase), false);
                if (obj.Length == 1)
                    return (CoreSettingAttributeBase)obj[0];
            }
            catch {
