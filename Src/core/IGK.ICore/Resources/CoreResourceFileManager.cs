...
file: CoreResourceFileManager.cs
...
namespace IGK.ICore.Resources
{
    ...
    /// </summary>
    public sealed class CoreResourceFileManager
    {
        private static CoreResourceFileManager sm_instance;
        List<ICoreWorkingResourcesContainerSurface> m_dic;
        string m_targetDir;
        private CoreResourceFileManager()
        {
            m_dic = new List<ICoreWorkingResourcesContainerSurface>();
            m_targetDir = IGK.ICore.IO.PathUtils.GetPath("%startup%/Temp/Res");
        }
        internal  static CoreResourceFileManager Instance
        {
            get
            {
                return sm_instance;
        ...
        static CoreResourceFileManager()
        {
            sm_instance = new CoreResourceFileManager();
        ...
        public static ICoreTextureResource CreateTextureRes(ICoreWorkingResourcesContainerSurface  target , string filename, string name, ICoreBitmap bitmap)
        {
            ...
            ICoreTextureResource c = null;
            //c = new TextureResource(
