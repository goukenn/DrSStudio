...
namespace IGK.GS.Mecanism
{
    /// <summary>
    /// Represent the mecanism filtering action.
    /// </summary>
    public abstract class GSMecanismAction
    {
        ...
        protected GSMecanismAction(ICoreWorkingMecanism mecanism)
        {
        ...
        //    enuKeys s = CoreApplicationBase.ModifierKeys | k;            
        //    if (this.Contains(s))
        //    {
