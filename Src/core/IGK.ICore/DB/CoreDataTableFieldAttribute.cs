...
namespace IGK.ICore.DB
{
    ...
    /// </summary>
    public class CoreDataTableFieldAttribute : Attribute
    {
        private enuCoreDataField m_Biding;
        private int m_MemberIndex;
        private int m_Length;
        private string m_TypeName;
        private string m_ColumnName;
        private enuCoreDataRelation m_Relation;
        ...
        /// </summary>
        public enuCoreDataRelation Relation
        {
        ...
        public enuCoreDataField Binding
        {
            get { return m_Biding; }
            set
            {
        ...
        public CoreDataTableFieldAttribute(enuCoreDataField biding)
            : this()
        {
        ...
        public CoreDataTableFieldAttribute()
        {
            this.m_Biding = enuCoreDataField.None;
            this.m_Length = 11;
