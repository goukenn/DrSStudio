...
namespace NetWGLFileGenerator
{
    public class wglewTraductor
    {
        ...
        {
            //prise du fichier 
            string infilename = "wglew.h";
            string outfilename = "wglew.cs";
        ...
        string str = string.Empty;
            ...
            str += "public partial class WGLApi {\n";
  ...
  //détection de constante
            ...
            {
                str = "internal const uint " + name + " = " + value + ";";
                ...
                { 
                    //detecte Delegate
                    str = "internal delegate " + type + " " + name + " " + param;
           ...
           private static bool DetectAdditionalValue(string str, out string type, out string name)
        {
            ...
            strTab = str.Split(' ');           
                if (strTab.Length > 2)
                {
                    if (strTab[2].StartsWith("WGLEW_GET_VAR"))
                    {
                        type = "bool";
        ...
        private static bool DetectAdditionaleMethod(string str, out string type, out string name)
        {
            ...
            //if (str.Contains("GLEW_GET_FUN"))
            //    {
            //    }
            if (strTab.Length > 2)
            {
                if (strTab[2].StartsWith("WGLEW_GET_FUN"))
                {
        ...
        {
              if (str.Contains ("PFNWGLALLOCATEMEMORYNVPROC"))
            {
            }
            str = str.Replace ("const char*","char[]");
            str = str.Replace ("  ", " ");
            string[] strTab = null;
            strTab = str.Split(' ');
        ...
        private static string ReplaceType(string str)
        {
            ...
            str = str.Replace("BOOL", "GLboolean");
            str = str.Replace("VOID", "GLvoid");
            str = str.Replace("DWORD", "int");
            str = str.Replace("UINT", "GLuint");
            str = str.Replace("USHORT", "GLushort");
            str = str.Replace("INT ", "GLint ");
            str = str.Replace("INT64 ", "GLint64 ");
            str = str.Replace("INT32 ", "GLint32 ");
            str = str.Replace("INT64*", "GLint64*");
            str = str.Replace("INT32*", "GLint32*");
            str = str.Replace("HDC", "GLvoid");
            str = str.Replace("HGPUNV","GLvoid");
            str = str.Replace("HANDLE","GLvoid");
            str = str.Replace("HPBUFFERARB","GLvoid");
            str = str.Replace("HPBUFFEREXT","GLvoid");
            str = str.Replace("HGLRC","GLvoid");
             str = str.Replace("PGPU_DEVICE","GLvoid");
            str = str.Replace("FLOAT", "float");
            ...
            str = ReplaceType(str, "GLint64", "Int64");
            str = ReplaceType(str, "GLint32", "Int32");
            ...
            str = str.Replace("  ", " ");
            str = str.Replace ("const int*","IntPtr ");
            str = str.Replace ("int*","IntPtr ");
            str = str.Replace ("int *","IntPtr ");
            str = str.Replace ("IntPtr *", "IntPtr ");
            str = str.Replace ("const float *","IntPtr ");
            str = str.Replace ("float *","IntPtr ");
            str = str.Replace ("float*","IntPtr ");
            str = str.Replace("GLsync", "IntPtr");
            str = str.Replace("LPIntPtr ","IntPtr ");
            return str;
        }
