...
namespace WinSnippetBuilder
{
    ...
    class SnippetBuilder
    {
        ...
        [Category("Snippet")]
        [Description("Obtient ou défninit le forma du snippet . par défault cette valeur est égal à 1.0.0.0")]
        ...
        [Category("Snippet")]
        [Description("Definit les déclarations associées")]
        ...
        [Category("Snippet")]
        [Description("Definit les importations associés")]
        ...
        [Category("Snippet")]
        [Description("Definit les references associés")]
