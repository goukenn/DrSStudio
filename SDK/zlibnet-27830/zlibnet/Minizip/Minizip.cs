...
namespace ZLibNet
{
	...
	internal static class Minizip
	{
        ...
        // Corrrected ... 
        [DllImport("zlib32.dll", EntryPoint = "setOpenUnicode", CallingConvention = CallingConvention.Cdecl)]
        static extern IntPtr setOpenUnicode_32(bool i);
        [DllImport(ZLibDll.Name64, EntryPoint = "setOpenUnicode", ExactSpelling = true, CallingConvention = CallingConvention.Cdecl)]
